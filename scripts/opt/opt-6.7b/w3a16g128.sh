...
--model /path/to/opt-6.7b --eval_ppl --save_dir ./fake_quant_model/opt-6.7b-w3a16g128 \
--epochs 20 --output_dir ./log/opt-6.7b-w3a16g128 --act-scales ./act_scales/opt-6.7b.pt --act-shifts ./act_shifts/opt-6.7b.pt \
