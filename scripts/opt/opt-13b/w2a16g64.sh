...
--model /path/to/opt-13b --eval_ppl --save_dir ./fake_quant_model/opt-13b-w2a16g64 \
--epochs 40 --output_dir ./log/opt-13b-w2a16g64 --act-scales ./act_scales/opt-13b.pt --act-shifts ./act_shifts/opt-13b.pt \
