...
--model /path/to/opt-30b --eval_ppl --save_dir ./fake_quant_model/opt-30b-w3a16 \
--epochs 20 --output_dir ./log/opt-30b-w3a16 --act-scales ./act_scales/opt-30b.pt --act-shifts ./act_shifts/opt-30b.pt \
