...
--model /path/to/llama-7b-hf --eval_ppl --save_dir ./fake_quant_model/llama-7b-w3a16 \
--epochs 20 --output_dir ./log/llama-7b-w3a16 --act-scales ./act_scales/llama-7b.pt --act-shifts ./act_shifts/llama-7b.pt \
